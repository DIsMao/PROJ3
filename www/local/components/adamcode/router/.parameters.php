...
$arComponentParameters = [
    ...
    "PARAMETERS" => [
		'SECTION_PAGE_INCLUDE' => array(
            'PARENT' => 'BASE',
            'TYPE' => 'STRING',
            'NAME' => 'Подключаемая страница для раздела',
            "DEFAULT" => '',
        ),
		'SECTIONS_PAGE_INCLUDE' => array(
			'PARENT' => 'BASE',
			'TYPE' => 'STRING',
			'NAME' => 'Подключаемая страница для разделов',
			"DEFAULT" => '',
		),
	'ELEMENT_PAGE_INCLUDE' => array(
		'PARENT' => 'BASE',
		'TYPE' => 'STRING',
		'NAME' => 'Подключаемая страница для элемента',
		"DEFAULT" => '',
	),
